...
require 'yard/handlers/ruby/mongoid/relations/embedded_in_handler'
require 'yard/handlers/ruby/mongoid/relations/embeds_one_handler'
require 'yard/handlers/ruby/mongoid/relations/embeds_many_handler'
